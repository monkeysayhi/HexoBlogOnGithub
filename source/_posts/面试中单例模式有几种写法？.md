...
变种2的核心是DCL，看起来变种2似乎已经达到了理想的效果：懒加载+线程安全。可惜的是，正如注释中所说，DCL仍然是线程不安全的，由于指令重排序，你可能会得到“半个对象”。详细在看完变种3后，可参考我之前的一篇文章，这里不再赘述。

>参考：[volatile关键字的作用、原理](/2016/11/29/volatile%E5%85%B3%E9%94%AE%E5%AD%97%E7%9A%84%E4%BD%9C%E7%94%A8%E3%80%81%E5%8E%9F%E7%90%86/)
...
>上面的分析都忽略了反射和序列化的问题。**通过反射或序列化，我们仍然能够访问到私有构造器，创建新的实例破坏单例模式**。此时，只有枚举模式能天然防范这一问题。反射和序列化我还不太了解，但基本原理并不难，可以在其他模式上手动实现。
